...
# assertion, so a cross-arch build of this stage fails outright on an arm64
# host. Building natively also removes emulation from the slowest stage of a
# multi-arch build.
# ==============================================================================
...
RUN mkdir -p /var/log/openfec-mcp-server && chown -R bun:bun /var/log/openfec-mcp-server
...
ENV LOGS_DIR="/var/log/openfec-mcp-server"
